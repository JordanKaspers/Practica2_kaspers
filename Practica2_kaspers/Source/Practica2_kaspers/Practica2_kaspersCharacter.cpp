...
APractica2_kaspersCharacter::APractica2_kaspersCharacter()
{
...
void APractica2_kaspersCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
  ...
  */
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &APractica2_kaspersCharacter::TurnAtRate);
...
void APractica2_kaspersCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APractica2_kaspersCharacter::MoveForward(float Value)
{
...
void APractica2_kaspersCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
